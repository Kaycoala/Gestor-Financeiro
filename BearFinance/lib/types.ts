...
export interface DadosGlobais {
  ...
  gastosFixosExcluidos: Record<string, number[]> // chave: "ano_mes", valor: array de ids excluídos
  gastosFixosExcluidosAPartirDe: Record<number, string> // chave: id do gasto, valor: "ano_mes" a partir de quando foi excluído
}
