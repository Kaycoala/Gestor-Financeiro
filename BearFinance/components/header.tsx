          ...
          <div className="relative">
            ...
            {showMonthPicker && (
              <>
                ...
                />
                <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 sm:absolute sm:left-auto sm:top-full sm:right-0 sm:translate-x-0 sm:translate-y-0 sm:mt-2 bg-card border border-border rounded-lg shadow-lg z-50 p-4 w-[calc(100vw-2rem)] max-w-72 sm:w-72">
                  {/* Year selector */}
